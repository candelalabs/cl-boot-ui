(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		define(["_", "react", "react-dom"], factory);
	else if(typeof exports === 'object')
		exports["cl-boot-ui"] = factory(require("lodash"), require("react"), require("react-dom"));
	else
		root["cl-boot-ui"] = factory(root["_"], root["React"], root["ReactDOM"]);
})(window, function(__WEBPACK_EXTERNAL_MODULE_lodash__, __WEBPACK_EXTERNAL_MODULE_react__, __WEBPACK_EXTERNAL_MODULE_react_dom__) {
...
var TouchRipple_1 = __webpack_require__(/*! ../ripple/TouchRipple */ "./src/ripple/TouchRipple.tsx");
...
var Button = /** @class */ (function (_super) {
    ...
    Button.prototype.render = function () {
        var _this = this;
        return (React.createElement("button", { className: classnames_1.default("cl-button-root", this.props.className), onMouseDown: function (event) {
...
var React = __webpack_require__(/*! react */ "react");
var BaseWidget_1 = __webpack_require__(/*! ../common/BaseWidget */ "./src/common/BaseWidget.tsx");
var Modal_1 = __webpack_require__(/*! @material-ui/core/Modal */ "./node_modules/@material-ui/core/esm/Modal/index.js");
var Backdrop_1 = __webpack_require__(/*! @material-ui/core/Backdrop */ "./node_modules/@material-ui/core/esm/Backdrop/index.js");
var Fade_1 = __webpack_require__(/*! @material-ui/core/Fade */ "./node_modules/@material-ui/core/esm/Fade/index.js");
var Dialog = /** @class */ (function (_super) {
    __extends(Dialog, _super);
    function Dialog(props) {
        var _this = _super.call(this, "dialog", props) || this;
        _this.state = {};
        return _this;
    }
    Dialog.prototype.render = function () {
        return (React.createElement(Modal_1.default, { "aria-labelledby": "transition-modal-title", "aria-describedby": "transition-modal-description", className: "cl-dialog", open: this.props.open, onClose: this.props.onClose, closeAfterTransition: true, BackdropComponent: Backdrop_1.default, BackdropProps: {
                timeout: 500,
            } },
            React.createElement(Fade_1.default, { in: this.props.open },
                React.createElement("div", { className: "cl-dialog-container" },
                    React.createElement("div", { className: "cl-dialog-header" }, this.props.header),
                    React.createElement("div", { className: "cl-dialog-content" }, this.props.children)))));
    };
    return Dialog;
}(BaseWidget_1.BaseWidget));
...
var Expander = /** @class */ (function (_super) {
    ...
    function Expander(props) {
        var _this = _super.call(this, "expander", props) || this;
        _this.state = {
            expanded: false
        };
        return _this;
    ...
    Expander.prototype.render = function () {
        ...
        return (React.createElement("div", { className: classnames_1.default("cl-expander", expanded ? "expanded" : "") },
            React.createElement("button", { className: "cl-expander-button", onClick: function () { _this.setState({ expanded: !_this.state.expanded }); } },
                React.createElement("div", { className: "plus-icon" }, "+"),
                React.createElement("span", null, "Detailed Analysis")),
            React.createElement(react_transition_group_1.CSSTransition, { in: expanded, timeout: 200, classNames: "cl-expander-transition", unmountOnExit: true },
                React.createElement("div", { className: "cl-expander-content" }, this.props.children))));
    };
    return Expander;
}(BaseWidget_1.BaseWidget));
...
__export(__webpack_require__(/*! ./progress-pane/ProgressPane */ "./src/progress-pane/ProgressPane.tsx"));
__export(__webpack_require__(/*! ./dialog/Dialog */ "./src/dialog/Dialog.tsx"));
...
/***/ "./src/progress-pane/ProgressPane.tsx":
/*!********************************************!*\
  !*** ./src/progress-pane/ProgressPane.tsx ***!
  \********************************************/
/*! no static exports found */
...
var React = __webpack_require__(/*! react */ "react");
var classnames_1 = __webpack_require__(/*! classnames */ "./node_modules/classnames/index.js");
var ProgressPane = /** @class */ (function (_super) {
    __extends(ProgressPane, _super);
    ...
    ProgressPane.prototype.componentDidMount = function () {
    };
    ProgressPane.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "fna-tab" }, this.props.data.map(function (item, index) {
            return (React.createElement("div", { className: classnames_1.default("fna-tab-item", index === _this.state.selectedIndex ? "selected" : ""), onClick: function () {
...
exports.ProgressPane = ProgressPane;
...
var BaseWidget_1 = __webpack_require__(/*! ../common/BaseWidget */ "./src/common/BaseWidget.tsx");
var classnames_1 = __webpack_require__(/*! classnames */ "./node_modules/classnames/index.js");
var Transition_1 = __webpack_require__(/*! react-transition-group/Transition */ "./node_modules/react-transition-group/esm/Transition.js");
exports.RipplePropTypes = {
    /**
     * Override or extend the styles applied to the component.
...
var Ripple = /** @class */ (function (_super) {
    ...
    function Ripple(props) {
        var _this = _super.call(this, "ripple", props) || this;
        _this.handleEnter = function () {
            _this.setState({
                visible: true,
            });
    ...
    Ripple.prototype.render = function () {
        var _a = this.props, classNameProp = _a.className, pulsate = _a.pulsate, rippleX = _a.rippleX, rippleY = _a.rippleY, rippleSize = _a.rippleSize, other = __rest(_a, ["className", "pulsate", "rippleX", "rippleY", "rippleSize"]);
        var _b = this.state, visible = _b.visible, leaving = _b.leaving;
        var rippleClassName = classnames_1.default("cl-touch-ripple-ripple", {
        ...
        var childClassName = classnames_1.default("cl-touch-ripple-child", {
            "cl-touch-ripple-childLeaving": leaving,
            "cl-touch-ripple-childPulsate": pulsate,
        });
        return (
        // @ts-ignore timeout
        React.createElement(Transition_1.default, __assign({ onEnter: this.handleEnter, onExit: this.handleExit }, other),
            React.createElement("span", { className: rippleClassName, style: rippleStyles },
                React.createElement("span", { className: childClassName }))));
    };
    Ripple.propTypes = exports.RipplePropTypes;
    Ripple.defaultProps = {
        pulsate: false,
    };
    return Ripple;
...
var BaseWidget_1 = __webpack_require__(/*! ../common/BaseWidget */ "./src/common/BaseWidget.tsx");
var react_transition_group_1 = __webpack_require__(/*! react-transition-group */ "./node_modules/react-transition-group/esm/index.js");
var Ripple_1 = __webpack_require__(/*! ./Ripple */ "./src/ripple/Ripple.tsx");
var DURATION = 550;
exports.DELAY_RIPPLE = 80;
var TouchRipple = /** @class */ (function (_super) {
    __extends(TouchRipple, _super);
    function TouchRipple(props) {
        var _this = _super.call(this, "touch-ripple", props) || this;
        _this.pulsate = function () {
            _this.start({}, { pulsate: true });
        };
        _this.start = function (event, options, cb) {
            if (event === void 0) { event = {}; }
            if (options === void 0) { options = {}; }
            var _a = options.pulsate, pulsate = _a === void 0 ? false : _a, _b = options.center, center = _b === void 0 ? _this.props.center || options.pulsate : _b, _c = options.fakeElement, fakeElement = _c === void 0 ? false : _c;
            ...
            if (event.touches) {
                ...
                // Delay the execution of the ripple effect.
                _this.startTimer = window.setTimeout(function () {
                    if (_this.startTimerCommit) {
                        _this.startTimerCommit();
                        _this.startTimerCommit = null;
                    }
                }, exports.DELAY_RIPPLE); // We have to make a tradeoff with this value.
            }
            else {
                _this.startCommit({ pulsate: pulsate, rippleX: rippleX, rippleY: rippleY, rippleSize: rippleSize, cb: cb });
            }
        ...
        _this.startCommit = function (params) {
            ...
            _this.setState(function (state) { return ({
                ...
                ripples: __spreadArrays(state.ripples, [
                    React.createElement(Ripple_1.default, { key: state.nextKey, timeout: {
                            exit: DURATION,
                            enter: DURATION,
    ...
    TouchRipple.prototype.componentWillUnmount = function () {
        clearTimeout(this.startTimer);
    };
    TouchRipple.prototype.render = function () {
        var _a = this.props;
        var ripples = this.state.ripples;
        return (React.createElement("span", { className: "cl-touch-ripple-root" },
            React.createElement(react_transition_group_1.TransitionGroup, { component: null, exit: true }, ripples)));
    };
    return TouchRipple;
}(BaseWidget_1.BaseWidget));
...
var SelectionPaneWidget = /** @class */ (function (_super) {
    ...
    function SelectionPaneWidget(props) {
        var _this = _super.call(this, "selection-pane", props) || this;
        _this.state = {
            selectedIndex: 0
        };
        return _this;
    ...
    SelectionPaneWidget.prototype.render = function () {
        var _this = this;
        return (React.createElement("div", { className: "selection-pane-container" }, this.props.data.map(function (item, index) {
            return (React.createElement("button", { className: classnames_1.default("selection-button", _this.state.selectedIndex === index ? "selected" : ""), onClick: function () {
                    _this.setState({ selectedIndex: index });
                } }, item.title));
        })));
    };
...
var PrettoSlider = styles_1.withStyles({
    root: {
        color: '#30308b',
        height: 10,
    },
...
var Slider = /** @class */ (function (_super) {
    ...
    function Slider(props) {
        return _super.call(this, "slider", props) || this;
    }
    Slider.prototype.render = function () {
        return (React.createElement(PrettoSlider, { valueLabelDisplay: "auto", "aria-label": "pretto slider", defaultValue: 20 }));
    };
    return Slider;
}(BaseWidget_1.BaseWidget));
...
var React = __webpack_require__(/*! react */ "react");
var BaseWidget_1 = __webpack_require__(/*! ../common/BaseWidget */ "./src/common/BaseWidget.tsx");
var Switch_1 = __webpack_require__(/*! @material-ui/core/Switch */ "./node_modules/@material-ui/core/esm/Switch/index.js");
var styles_1 = __webpack_require__(/*! @material-ui/core/styles */ "./node_modules/@material-ui/core/esm/styles/index.js");
var Grid_1 = __webpack_require__(/*! @material-ui/core/Grid */ "./node_modules/@material-ui/core/esm/Grid/index.js");
var IOSSwitch = styles_1.withStyles(function (theme) { return ({
    root: {
        width: 42,
        height: 26,
        padding: 0,
    ...
    return (React.createElement(Switch_1.default, __assign({ focusVisibleClassName: classes.focusVisible, disableRipple: true, classes: {
            root: classes.root,
...
var Switch = /** @class */ (function (_super) {
    ...
    function Switch(props) {
        return _super.call(this, "switch", props) || this;
    }
    Switch.prototype.render = function () {
        return (React.createElement(Grid_1.default, { component: "label", container: true, alignItems: "center", spacing: 1 },
            React.createElement(Grid_1.default, { item: true, className: "left-label" }, this.props.leftLabel),
            React.createElement(Grid_1.default, { item: true, className: "switch-container" },
                React.createElement(IOSSwitch, __assign({}, this.props))),
            React.createElement(Grid_1.default, { item: true, className: "right-label" }, this.props.rightLabel)));
    };
    return Switch;
}(BaseWidget_1.BaseWidget));
